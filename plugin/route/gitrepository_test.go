...
func TestListGitRepository(t *testing.T) {
	...
	httpRequest, _ := http.NewRequest("GET", "/plugins/v1alpha1/test-6/projects/1/coderepositories", nil)
...
func (t *TestGitRepositoryLister) ListGitRepository(ctx context.Context, id string, listOption metav1alpha1.ListOptions) (metav1alpha1.GitRepositoryList, error) {
