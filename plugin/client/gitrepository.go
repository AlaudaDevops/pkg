...
type ClientGitRepository interface {
	List(ctx context.Context, baseURL *duckv1.Addressable, id string, options ...OptionFunc) (*metav1alpha1.GitRepositoryList, error)
}
...
func (g *gitRepository) List(ctx context.Context, baseURL *duckv1.Addressable, id string, options ...OptionFunc) (*metav1alpha1.GitRepositoryList, error) {
	...
	uri := fmt.Sprintf("projects/%s/coderepositories", id)
